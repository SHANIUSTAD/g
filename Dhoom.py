...
#     #    # #     #  ##      #     ##    #  
 ...
 #   #    #   #   #           #     # #   #  
  ...
  # #     #   #      ##       #     #  #  #  
   ...
   #     #     #  ##   #      #     #    ##  
 #####   ##   ##  # ###    #######  ##    #  
                                         ..::::..::..:::::..::..:::::..::..::::..::\n\t\n'\x1b[1;92m'   Author      :     MUHAMMAD YASIN    \n'\x1b[1;91m'   Github      :     cyberXyasin404\n'\x1b[1;96m'   FB ID       :   Muhammad Yasin \n'\x1b[1;93m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;91m'   WAP NUMBER  :     03305867095            \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    r1 = requests.get('https://raw.githubusercontent.com/Subh/main/server.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '        Member In yasin Paid Commands '
...
def fb_menu():
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;92m[1] Public Cloning  [YASINPro]'
    print '\x1b[1;92m[2] Public Cloning  [YASINFast]'
    print '\x1b[1;91m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning YASINPro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning YASINFast ]'
        print ''
